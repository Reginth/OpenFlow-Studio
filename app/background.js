...
/* harmony import */ var _helpers_window__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers/window */ "./src/helpers/window.js");
...
ipcMain.on('project', function (event) {
  const modalPath = path__WEBPACK_IMPORTED_MODULE_0___default.a.join('file://', __dirname, 'project.html');
...
const setApplicationMenu = () => {
  ...
  if (env__WEBPACK_IMPORTED_MODULE_5__.name !== "production") {
...
if (env__WEBPACK_IMPORTED_MODULE_5__.name !== "production") {
  ...
  electron__WEBPACK_IMPORTED_MODULE_2__["app"].setPath("userData", `${userDataPath} (${env__WEBPACK_IMPORTED_MODULE_5__.name})`);
}

var mainWindow = "";
electron__WEBPACK_IMPORTED_MODULE_2__["app"].on("ready", () => {
  setApplicationMenu();
  mainWindow = Object(_helpers_window__WEBPACK_IMPORTED_MODULE_4__["default"])("main", {
    width: 1000,
    height: 600,
    minWidth: 700,
    minHeight: 350,
  ...
  if (env__WEBPACK_IMPORTED_MODULE_5__.name === "development") {
